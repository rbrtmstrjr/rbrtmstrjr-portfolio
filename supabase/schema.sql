...
-- ---------------------------------------------------------------------------
-- Accent palettes — the CURATED MENU of accent colors. The admin manages the
-- options and marks one default; each VISITOR picks from the menu and the
-- choice lives in their own localStorage (no visitor writes here, ever).
-- Public read is intentional: the whole menu ships to the public site.
-- Scales are 11-shade hex objects {"50":"#…", …, "950":"#…"}; theme.css
-- blue/aquamarine remain the hardcoded fallback when this table is empty.
-- ---------------------------------------------------------------------------
